...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'gnarnold';//this will be your WCC username
      $dbUsr = 'gnarnold';//this will be your WCC username
      $dbPass = 'zzAJAu9zkv2g';//this will be the password found in the video.
